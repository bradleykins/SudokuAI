...
public class Sudoku_AI_ForwardCheckingTest {
    ...
    /**
     * Test of getSolution method, of class Sudoku_AI_ForwardChecking.
     */
    @Test
    public void testGetSolution() {
        ...
        for (int i=0;i<BOARDSIZE;i++){
            for (int j=0;j< BOARDSIZE;j++){
                expected[i][j] = Integer.parseInt(""+puzzleSolved.charAt(i*9+j));
            }            
        }            
        
        Sudoku_AI_ForwardChecking instance = new Sudoku_AI_ForwardChecking(BOXSIZE);
    ...
    /**
     * Test of getName method, of class Sudoku_AI_ForwardChecking.
     */
    @Test
    public void testGetName() {
        System.out.println("getName");
        Sudoku_AI_ForwardChecking instance = new Sudoku_AI_ForwardChecking(BOXSIZE);
        String expResult = "Backtracking with Forward Checking";
